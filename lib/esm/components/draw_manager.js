...
export function DrawManager(props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        polylineCreate && !!polylineModel[0].filter(function (lngLat) { return lngLat > 0; }).length && (React.createElement(React.Fragment, null,
            showMarkers && polylineModel.map(function (model, idx, models) { return (React.createElement(HtmlMarker, { coordinates: model, html: ReactDOMServer.renderToString(React.createElement(HtmlMarkerHtml, { last: idx === models.length - 1 })), handlers: idx === models.length - 1 ? lineLastMarkerHandlers : undefined, key: model[0] + model[1] })); }),
        ...
        polygonCreate && !!polygonModel[0].filter(function (lngLat) { return lngLat > 0; }).length && (React.createElement(React.Fragment, null,
            showMarkers && polygonModel.map(function (model, idx, models) { return (React.createElement(HtmlMarker, { coordinates: model, html: ReactDOMServer.renderToString(React.createElement(HtmlMarkerHtml, { last: idx === models.length - 1 })), handlers: idx === models.length - 1 ? lineLastMarkerHandlers : undefined, key: model[0] + model[1] })); }),
