...
export function MarkerWithTooltip(props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        props.tooltip.text && !!props.tooltip.text.trim().length && showTooltip && (React.createElement(HtmlMarker, { coordinates: props.coordinates, html: ReactDOMServer.renderToString(React.createElement(Tooltip, { tooltip: props.tooltip })), handlers: {
                click: function (e) { var _a; return (_a = props.tooltipHandlers) === null || _a === void 0 ? void 0 : _a.click(e, setShowTooltip); }
            } }))));
}
