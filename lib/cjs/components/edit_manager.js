    ...
    react_1.default.useEffect(function () {
        ...
        switch (props.figureType) {
            ...
            case allFigures.Polygon:
                ...
                setPolygonModel(function () { return props.figureData.points.map(function (bound) { return helpers_1.createBoundTuple(bound); }); });
                break;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        circleCreate && circleModel.coordinates.length === 2 && (react_1.default.createElement(react_1.default.Fragment, null,
            showMarkers && circleModel.radius && (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(marker_html_1.HtmlMarker, { coordinates: circleModel.coordinates, html: server_1.default.renderToString(react_1.default.createElement(draw_manager_1.HtmlCircleMarkerHtml, null)), handlers: circleCenterMarkerHandlers }))),
