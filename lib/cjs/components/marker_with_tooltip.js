...
function MarkerWithTooltip(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(marker_1.Marker, { coordinates: props.coordinates, handlers: {
            ...
            }, onCreate: props.onCreate, onDestroy: props.onDestroy }),
        props.tooltip.text && !!props.tooltip.text.trim().length && showTooltip && (react_1.default.createElement(marker_html_1.HtmlMarker, { coordinates: props.coordinates, html: server_1.default.renderToString(react_1.default.createElement(Tooltip, { tooltip: props.tooltip })), handlers: {
                click: function (e) { var _a; return (_a = props.tooltipHandlers) === null || _a === void 0 ? void 0 : _a.click(e, setShowTooltip); }
            } }))));
}
